...
TARGET_FRIENDLYWRT_CONFIG=config_h3_zhw
...
TARGET_SD_RAW_FILENAME=FriendlyWrt_$(date +%Y%m%d)_NanoPi-NEO-Core_armhf_sd.img
TARGET_EFLASHER_RAW_FILENAME=FriendlyWrt_$(date +%Y%m%d)_NanoPi-NEO-Core_armhf_eflasher.img
